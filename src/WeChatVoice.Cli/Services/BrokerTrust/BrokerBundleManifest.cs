...
/// </summary>
internal sealed record BrokerBundleManifest(
...
internal static class BrokerBundleManifestLoader
{
    private static readonly JsonSerializerOptions ManifestOptions = new(JsonSerializerDefaults.Web);

    internal static BrokerBundleManifest? TryLoad(string installDirectory)
    {
    ...
    /// </summary>
    internal static bool VerifySidecars(string installDirectory, BrokerBundleManifest manifest)
    {
