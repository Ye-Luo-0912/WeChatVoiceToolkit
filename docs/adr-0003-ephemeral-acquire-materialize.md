...
The current built-in Profile registry is empty. The Broker returns
`profile_unavailable` and does not inspect a real process until an exact Profile
passes fixtures and full materialization validation.
